...
namespace Automattic\WooCommerce\EmailEditor\Engine\PersonalizationTags {
    ...
    class Personalization_Tags_Registry
    {
         ...
         */
        public function unregister($token_or_tag): ?\Automattic\WooCommerce\EmailEditor\Engine\PersonalizationTags\Personalization_Tag
        {
        }
        /**
...
namespace Automattic\WooCommerce\EmailEditor\Integrations\WooCommerce\Renderer\Blocks {
    ...
    class Product_Collection extends \Automattic\WooCommerce\EmailEditor\Integrations\WooCommerce\Renderer\Blocks\Abstract_Product_Block_Renderer
    {
         ...
         * @return WP_Query
         */
        private function prepare_and_execute_query(array $parsed_block, \Automattic\WooCommerce\EmailEditor\Engine\Renderer\ContentRenderer\Rendering_Context $rendering_context): \WP_Query
        {
        }
        /**
         ...
         */
        private function get_collection_specific_product_ids(string $collection, array $parsed_block, \Automattic\WooCommerce\EmailEditor\Engine\Renderer\ContentRenderer\Rendering_Context $rendering_context): array
        {
        }
        /**
         ...
         */
        private function get_cart_contents_product_ids(array $parsed_block, \Automattic\WooCommerce\EmailEditor\Engine\Renderer\ContentRenderer\Rendering_Context $rendering_context): array
        {
        }
        /**
         ...
         */
        private function get_user_cart_product_ids_from_context(\Automattic\WooCommerce\EmailEditor\Engine\Renderer\ContentRenderer\Rendering_Context $rendering_context): array
        {
        }
        /**
...
namespace Automattic\WooCommerce\EmailEditorVendor\Pelago\Emogrifier\Css {
    ...
    final class CssDocument
    {
         ...
         */
        private function getFilteredAtIdentifierAndRule(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\CSSList\AtRuleBlockList $rule, array $allowedMediaTypes): ?string
        {
        }
        /**
         ...
         * @return bool
         */
        private function isValidAtRuleToRender(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Renderable $rule): bool
        {
        }
    }
    /**
    ...
    final class StyleRule
    {
         ...
         */
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\RuleSet\DeclarationBlock $declarationBlock, string $containingAtRule = '')
        {
        }
        /**
...
namespace Automattic\WooCommerce\EmailEditorVendor\Pelago\Emogrifier {
     ...
     */
    final class CssInliner extends \Automattic\WooCommerce\EmailEditorVendor\Pelago\Emogrifier\HtmlProcessor\AbstractHtmlProcessor
    {
        /**
         * @var int
         */
         ...
         */
        private function getCssSelectorConverter(): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\CssSelectorConverter
        {
        }
        /**
         ...
         */
        private function collateCssRules(\Automattic\WooCommerce\EmailEditorVendor\Pelago\Emogrifier\Css\CssDocument $parsedCss): array
        {
        }
        /**
         ...
         */
        private function copyUninlinableCssToStyleNode(\Automattic\WooCommerce\EmailEditorVendor\Pelago\Emogrifier\Css\CssDocument $parsedCss): void
        {
        }
        /**
...
namespace Automattic\WooCommerce\EmailEditorVendor\Pelago\Emogrifier\HtmlProcessor {
     ...
     */
    final class CssToAttributeConverter extends \Automattic\WooCommerce\EmailEditorVendor\Pelago\Emogrifier\HtmlProcessor\AbstractHtmlProcessor
    {
        /**
     ...
     */
    final class CssVariableEvaluator extends \Automattic\WooCommerce\EmailEditorVendor\Pelago\Emogrifier\HtmlProcessor\AbstractHtmlProcessor
    {
        /**
     ...
     * - reformat the HTML
     */
    final class HtmlNormalizer extends \Automattic\WooCommerce\EmailEditorVendor\Pelago\Emogrifier\HtmlProcessor\AbstractHtmlProcessor
    {
    }
    /**
     * This class can remove things from HTML.
     */
    final class HtmlPruner extends \Automattic\WooCommerce\EmailEditorVendor\Pelago\Emogrifier\HtmlProcessor\AbstractHtmlProcessor
    {
        /**
         ...
         */
        public function removeRedundantClassesAfterCssInlined(\Automattic\WooCommerce\EmailEditorVendor\Pelago\Emogrifier\CssInliner $cssInliner): self
        {
        }
    }
}
...
namespace Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS {
     ...
     */
    interface CSSElement extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Renderable
    {
    }
}
...
namespace Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Property {
    interface AtRule extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Renderable, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Comment\Commentable
    {
        /**
...
namespace Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\CSSList {
     ...
     */
    abstract class CSSList implements \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Comment\Commentable, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\CSSElement, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Positionable
    {
         ...
         */
        public static function parseList(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\ParserState $oParserState, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\CSSList\CSSList $oList)
        {
        }
        /**
         ...
         * @throws UnexpectedTokenException
         */
        private static function parseListItem(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\ParserState $oParserState, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\CSSList\CSSList $oList)
        {
        }
        /**
         ...
         * @throws UnexpectedEOFException
         */
        private static function parseAtRule(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\ParserState $oParserState)
        {
        }
        /**
         ...
         * @return string
         */
        protected function renderListContents(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\OutputFormat $oOutputFormat)
        {
        }
        /**
     ...
     */
    abstract class CSSBlockList extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\CSSList\CSSList
    {
        /**
         * @param int $iLineNo
         */
     ...
     */
    class AtRuleBlockList extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\CSSList\CSSBlockList implements \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Property\AtRule
    {
        /**
         * @var string
         */
     ...
     */
    class Document extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\CSSList\CSSBlockList
    {
        /**
         * @param int $iLineNo
         */
         ...
         * @internal since V8.8.0
         */
        public static function parse(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\ParserState $oParserState)
        {
        }
        /**
    ...
    class KeyFrame extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\CSSList\CSSList implements \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Property\AtRule
    {
        /**
         * @var string|null
         */
...
namespace Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Comment {
    class Comment implements \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Positionable, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Renderable
    {
        use \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Position;
        /**
         * @var string
...
namespace Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS {
    ...
    class OutputFormatter
    {
         ...
         */
        private $oFormat;
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\OutputFormat $oFormat)
        {
        }
        /**
         * @param string $sName
         ...
         * @return string
         */
        public function comments(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Comment\Commentable $oCommentable)
        {
        }
        /**
...
namespace Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing {
    ...
    class Anchor
    {
         ...
         */
        public function __construct($iPosition, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\ParserState $oParserState)
        {
        }
        /**
         * @return void
    ...
    class SourceException extends \Exception implements \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Positionable
    {
        use \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Position;
        /**
     ...
     */
    class OutputException extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\SourceException
    {
        /**
         * @param string $sMessage
         * @param int $iLineNo
    ...
    class ParserState
    {
         ...
         * @param int $iLineNo
         */
        public function __construct($sText, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Settings $oParserSettings, $iLineNo = 1)
        {
        }
        /**
         * Sets the charset to be used if the CSS does not contain an `@charset` declaration.
     ...
     */
    class UnexpectedTokenException extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\SourceException
    {
        /**
         * @var string
         */
     ...
     */
    class UnexpectedEOFException extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\UnexpectedTokenException
    {
    }
}
namespace Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Property {
     ...
     */
    class CSSNamespace implements \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Property\AtRule, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Positionable
    {
        use \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Position;
        /**
         * @var string
     ...
     */
    class Charset implements \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Property\AtRule, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Positionable
    {
        use \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Position;
        /**
         * @var CSSString
         ...
         * @param int $iLineNo
         */
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Value\CSSString $oCharset, $iLineNo = 0)
        {
        }
        /**
     ...
     */
    class Import implements \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Property\AtRule, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Positionable
    {
        use \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Position;
        /**
         * @var URL
         ...
         * @param int $iLineNo
         */
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Value\URL $oLocation, $sMediaQuery, $iLineNo = 0)
        {
        }
        /**
         * @param URL $oLocation
    ...
    class KeyframeSelector extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Property\Selector
    {
        /**
         * regexp for specificity calculations
         *
...
namespace Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Rule {
     ...
     */
    class Rule implements \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Comment\Commentable, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\CSSElement, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Positionable
    {
        use \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Position;
        /**
         * @var string
         ...
         * @internal since V8.8.0
         */
        public static function parse(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\ParserState $oParserState, $commentsBeforeRule = [])
        {
        }
        /**
...
namespace Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\RuleSet {
     ...
     */
    abstract class RuleSet implements \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\CSSElement, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Comment\Commentable, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Positionable
    {
        use \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Position;
        /**
         ...
         * @internal since V8.8.0
         */
        public static function parseRuleSet(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\ParserState $oParserState, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\RuleSet\RuleSet $oRuleSet)
        {
        }
        /**
         ...
         * @return void
         */
        public function addRule(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Rule\Rule $oRule, $oSibling = null)
        {
        }
        /**
         ...
         * @return string
         */
        protected function renderRules(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\OutputFormat $oOutputFormat)
        {
        }
        /**
     ...
     */
    class AtRuleSet extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\RuleSet\RuleSet implements \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Property\AtRule
    {
        /**
         * @var string
         */
     ...
     */
    class DeclarationBlock extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\RuleSet\RuleSet
    {
        /**
         ...
         * @internal since V8.8.0
         */
        public static function parse(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\ParserState $oParserState, $oList = null)
        {
        }
        /**
...
namespace Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Value {
     ...
     */
    abstract class Value implements \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\CSSElement, \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Positionable
    {
        use \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Position\Position;
        /**
         * @param int $iLineNo
         ...
         * @internal since V8.8.0
         */
        public static function parseValue(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\ParserState $oParserState, array $aListDelimiters = [])
        {
        }
        /**
         * @param bool $bIgnoreCase
         ...
         * @internal since V8.8.0
         */
        public static function parseIdentifierOrFunction(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\ParserState $oParserState, $bIgnoreCase = false)
        {
        }
        /**
         ...
         * @internal since V8.8.0
         */
        public static function parsePrimitiveValue(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\ParserState $oParserState)
        {
        }
        /**
         * @return CSSFunction
         ...
         * @throws UnexpectedTokenException
         */
        private static function parseMicrosoftFilter(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\ParserState $oParserState)
        {
        }
        /**
         * @return string
         ...
         * @throws UnexpectedTokenException
         */
        private static function parseUnicodeRangeValue(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\ParserState $oParserState)
        {
        }
    }
    /**
     ...
     */
    abstract class ValueList extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Value\Value
    {
        /**
     ...
     */
    class CSSFunction extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Value\ValueList
    {
        /**
         * @var string
         *
         ...
         * @internal since V8.8.0
         */
        public static function parse(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\ParserState $oParserState, $bIgnoreCase = false)
        {
        }
        /**
         * @return string
    ...
    abstract class PrimitiveValue extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Value\Value
    {
        /**
         * @param int $iLineNo
         */
     ...
     */
    class CSSString extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Value\PrimitiveValue
    {
        /**
         * @var string
         */
     ...
     */
    class CalcFunction extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Value\CSSFunction
    {
        /**
         * @var int
         *
     ...
     */
    class RuleValueList extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Value\ValueList
    {
        /**
         * @param string $sSeparator
         * @param int $iLineNo
    ...
    class CalcRuleValueList extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Value\RuleValueList
    {
        /**
         * @param int $iLineNo
         */
     ...
     */
    class Color extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Value\CSSFunction
    {
        /**
    ...
    class LineName extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Value\ValueList
    {
        /**
         * @param array<int, RuleValueList|CSSFunction|CSSString|LineName|Size|URL|string> $aComponents
         * @param int $iLineNo
     ...
     */
    class Size extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Value\PrimitiveValue
    {
        /**
         ...
         * @internal since V8.8.0
         */
        public static function parse(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Parsing\ParserState $oParserState, $bIsColorComponent = false)
        {
        }
        /**
     ...
     */
    class URL extends \Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Value\PrimitiveValue
    {
        /**
         * @var CSSString
         */
         ...
         * @param int $iLineNo
         */
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Value\CSSString $oURL, $iLineNo = 0)
        {
        }
        /**
         * @return URL
         ...
         * @return void
         */
        public function setURL(\Automattic\WooCommerce\EmailEditorVendor\Sabberworm\CSS\Value\CSSString $oURL)
        {
        }
        /**
         * @return CSSString
...
namespace Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Exception {
     ...
     */
    class ParseException extends \Exception implements \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Exception\ExceptionInterface
    {
    }
    /**
     * ParseException is thrown when a CSS selector syntax is not valid.
     ...
     * @author Jean-François Simon <jeanfrancois.simon@sensiolabs.com>
     */
    class ExpressionErrorException extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Exception\ParseException
    {
    }
    /**
     * ParseException is thrown when a CSS selector syntax is not valid.
     ...
     * @author Jean-François Simon <jeanfrancois.simon@sensiolabs.com>
     */
    class InternalErrorException extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Exception\ParseException
    {
    }
    /**
     * ParseException is thrown when a CSS selector syntax is not valid.
     ...
     * @author Jean-François Simon <jeanfrancois.simon@sensiolabs.com>
     */
    class SyntaxErrorException extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Exception\ParseException
    {
        /**
         * @return self
         */
        public static function unexpectedToken(string $expectedValue, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Token $foundToken)
        {
        }
        /**
         * @return self
...
namespace Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node {
    ...
    interface NodeInterface
    {
        ...
        public function getSpecificity(): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\Specificity;
     ...
     * @internal
     */
    abstract class AbstractNode implements \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface
    {
        /**
         * @var string
         */
     ...
     * @internal
     */
    class AttributeNode extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\AbstractNode
    {
        private $selector;
        private $namespace;
        private $attribute;
        private $operator;
        private $value;
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface $selector, ?string $namespace, string $attribute, string $operator, ?string $value)
        {
        }
        public function getSelector(): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface
        {
        }
     ...
     * @internal
     */
    class ClassNode extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\AbstractNode
    {
        private $selector;
        private $name;
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface $selector, string $name)
        {
        }
        public function getSelector(): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface
        {
     ...
     * @internal
     */
    class CombinedSelectorNode extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\AbstractNode
    {
        private $selector;
        private $combinator;
        private $subSelector;
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface $selector, string $combinator, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface $subSelector)
        {
        }
        public function getSelector(): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface
        {
        ...
        public function getSubSelector(): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface
        {
        }
        /**
         * {@inheritdoc}
     ...
     * @internal
     */
    class ElementNode extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\AbstractNode
    {
        private $namespace;
        private $element;
     ...
     * @internal
     */
    class FunctionNode extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\AbstractNode
    {
        private $selector;
        private $name;
        private $arguments;
         ...
         */
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface $selector, string $name, array $arguments = [])
        {
        }
        public function getSelector(): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface
        {
     ...
     * @internal
     */
    class HashNode extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\AbstractNode
    {
        private $selector;
        private $id;
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface $selector, string $id)
        {
        }
        public function getSelector(): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface
        {
     ...
     * @internal
     */
    class NegationNode extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\AbstractNode
    {
        private $selector;
        private $subSelector;
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface $selector, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface $subSelector)
        {
        }
        public function getSelector(): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface
        {
     ...
     * @internal
     */
    class PseudoNode extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\AbstractNode
    {
        private $selector;
        private $identifier;
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface $selector, string $identifier)
        {
        }
        public function getSelector(): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface
        {
     ...
     * @internal
     */
    class SelectorNode extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\AbstractNode
    {
        private $tree;
        private $pseudoElement;
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface $tree, ?string $pseudoElement = null)
        {
        }
        public function getTree(): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface
        {
        }
...
namespace Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Handler {
    ...
    {
        public function handle(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Reader $reader, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\TokenStream $stream): bool;
    }
    /**
     ...
     * @internal
     */
    class CommentHandler implements \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Handler\HandlerInterface
    {
        /**
         * {@inheritdoc}
         */
     ...
     * @internal
     */
    class HashHandler implements \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Handler\HandlerInterface
    {
        private $patterns;
        private $escaping;
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Tokenizer\TokenizerPatterns $patterns, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Tokenizer\TokenizerEscaping $escaping)
        {
        }
        /**
         * {@inheritdoc}
     ...
     * @internal
     */
    class IdentifierHandler implements \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Handler\HandlerInterface
    {
        private $patterns;
        private $escaping;
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Tokenizer\TokenizerPatterns $patterns, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Tokenizer\TokenizerEscaping $escaping)
     ...
     * @internal
     */
    class NumberHandler implements \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Handler\HandlerInterface
    {
        private $patterns;
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Tokenizer\TokenizerPatterns $patterns)
        {
        }
        /**
         * {@inheritdoc}
     ...
     * @internal
     */
    class StringHandler implements \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Handler\HandlerInterface
    {
        private $patterns;
        private $escaping;
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Tokenizer\TokenizerPatterns $patterns, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Tokenizer\TokenizerEscaping $escaping)
     ...
     * @internal
     */
    class WhitespaceHandler implements \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Handler\HandlerInterface
    {
        /**
         * {@inheritdoc}
         */
...
namespace Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser {
     ...
     * @internal
     */
    class Parser implements \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\ParserInterface
    {
        private $tokenizer;
        public function __construct(?\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Tokenizer\Tokenizer $tokenizer = null)
        {
        }
        /**
         * {@inheritdoc}
        ...
        private function parseSelectorList(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\TokenStream $stream): array
        {
        }
        private function parserSelectorNode(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\TokenStream $stream): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\SelectorNode
        {
        }
        /**
         ...
         * @throws SyntaxErrorException
         */
        private function parseSimpleSelector(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\TokenStream $stream, bool $insideNegation = false): array
        {
        }
        private function parseElementNode(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\TokenStream $stream): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\ElementNode
        {
        }
        private function parseAttributeNode(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface $selector, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\TokenStream $stream): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\AttributeNode
        {
        }
    }
    /**
...
namespace Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Shortcut {
     ...
     * @internal
     */
    class ClassParser implements \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\ParserInterface
    {
        /**
         * {@inheritdoc}
         */
     ...
     * @internal
     */
    class ElementParser implements \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\ParserInterface
    {
        /**
         * {@inheritdoc}
         */
     ...
     * @internal
     */
    class EmptyStringParser implements \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\ParserInterface
    {
        /**
         * {@inheritdoc}
         */
     ...
     * @internal
     */
    class HashParser implements \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\ParserInterface
    {
        /**
         * {@inheritdoc}
         */
...
namespace Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser {
    ...
    class TokenStream
    {
         ...
         * @return $this
         */
        public function push(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Token $token): self
        {
        }
        /**
         * Freezes stream.
         ...
         */
        public function getNext(): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Token
        {
        }
        /**
         * Returns peeked token.
         */
        public function getPeek(): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Token
        {
        }
        /**
         * Returns used tokens.
...
namespace Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Tokenizer {
    ...
    class Tokenizer
    {
         ...
         */
        public function tokenize(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\Reader $reader): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\TokenStream
        {
        }
    }
    /**
...
namespace Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Extension {
     ...
     * @internal
     */
    abstract class AbstractExtension implements \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Extension\ExtensionInterface
    {
        /**
         * {@inheritdoc}
         */
     ...
     * @internal
     */
    class AttributeMatchingExtension extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Extension\AbstractExtension
    {
        /**
         * {@inheritdoc}
         */
        ...
        public function translateExists(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, string $attribute, ?string $value): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateEquals(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, string $attribute, ?string $value): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateIncludes(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, string $attribute, ?string $value): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateDashMatch(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, string $attribute, ?string $value): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translatePrefixMatch(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, string $attribute, ?string $value): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateSuffixMatch(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, string $attribute, ?string $value): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateSubstringMatch(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, string $attribute, ?string $value): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateDifferent(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, string $attribute, ?string $value): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        /**
         * {@inheritdoc}
     ...
     * @internal
     */
    class CombinationExtension extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Extension\AbstractExtension
    {
        /**
         * {@inheritdoc}
         */
        ...
        public function translateDescendant(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $combinedXpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateChild(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $combinedXpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateDirectAdjacent(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $combinedXpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
     ...
     * @internal
     */
    class FunctionExtension extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Extension\AbstractExtension
    {
        /**
         * {@inheritdoc}
         */
         ...
         */
        public function translateNthChild(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\FunctionNode $function, bool $last = false, bool $addNameTest = true): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateNthLastChild(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\FunctionNode $function): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateNthOfType(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\FunctionNode $function): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        /**
         * @throws ExpressionErrorException
         ...
         * @throws ExpressionErrorException
         */
        public function translateContains(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\FunctionNode $function): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        /**
         * @throws ExpressionErrorException
         */
        public function translateLang(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\FunctionNode $function): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        /**
         * {@inheritdoc}
     ...
     * @internal
     */
    class HtmlExtension extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Extension\AbstractExtension
    {
        public function __construct(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Translator $translator)
        {
        }
        /**
         * {@inheritdoc}
        ...
        public function translateChecked(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateLink(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateDisabled(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateEnabled(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        /**
         * @throws ExpressionErrorException
        ...
        public function translateSelected(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateInvalid(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateHover(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateVisited(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        /**
         * {@inheritdoc}
     ...
     * @internal
     */
    class NodeExtension extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Extension\AbstractExtension
    {
        ...
        public function translateSelector(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\SelectorNode $node, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Translator $translator): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateCombinedSelector(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\CombinedSelectorNode $node, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Translator $translator): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateNegation(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NegationNode $node, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Translator $translator): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateFunction(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\FunctionNode $node, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Translator $translator): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translatePseudo(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\PseudoNode $node, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Translator $translator): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateAttribute(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\AttributeNode $node, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Translator $translator): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateClass(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\ClassNode $node, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Translator $translator): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateHash(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\HashNode $node, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Translator $translator): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateElement(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\ElementNode $node): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        /**
         * {@inheritdoc}
     ...
     * @internal
     */
    class PseudoClassExtension extends \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Extension\AbstractExtension
    {
        /**
         * {@inheritdoc}
         */
        ...
        public function translateRoot(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateFirstChild(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateLastChild(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        /**
         * @throws ExpressionErrorException
         */
        public function translateFirstOfType(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        /**
         * @throws ExpressionErrorException
         */
        public function translateLastOfType(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateOnlyChild(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateOnlyOfType(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        public function translateEmpty(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        /**
         * {@inheritdoc}
...
namespace Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath {
    ...
    interface TranslatorInterface
    {
         ...
         */
        public function selectorToXPath(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\SelectorNode $selector, string $prefix = 'descendant-or-self::'): string;
    }
    /**
     * XPath expression translator interface.
     *
     ...
     * @internal
     */
    class Translator implements \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\TranslatorInterface
    {
        private $mainParser;
        /**
         * @var ParserInterface[]
        ...
        public function __construct(?\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\ParserInterface $parser = null)
        {
        }
         ...
         * @return $this
         */
        public function registerExtension(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Extension\ExtensionInterface $extension): self
        {
        }
        /**
         * @throws ExpressionErrorException
         */
        public function getExtension(string $name): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\Extension\ExtensionInterface
        {
        }
        /**
         * @return $this
         */
        public function registerParserShortcut(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Parser\ParserInterface $shortcut): self
        {
        }
        /**
         * @throws ExpressionErrorException
         */
        public function nodeToXPath(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface $node): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        /**
         * @throws ExpressionErrorException
         */
        public function addCombination(string $combiner, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface $xpath, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\NodeInterface $combinedXpath): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        /**
         * @throws ExpressionErrorException
         */
        public function addFunction(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\Node\FunctionNode $function): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        /**
         * @throws ExpressionErrorException
         */
        public function addPseudoClass(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, string $pseudoClass): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        /**
         * @throws ExpressionErrorException
         */
        public function addAttributeMatching(\Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr $xpath, string $operator, string $attribute, ?string $value): \Automattic\WooCommerce\EmailEditorVendor\Symfony\Component\CssSelector\XPath\XPathExpr
        {
        }
        /**
         * @return SelectorNode[]
